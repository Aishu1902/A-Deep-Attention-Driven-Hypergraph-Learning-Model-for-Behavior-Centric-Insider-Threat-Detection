...
filepath=r'C:\Users\Ahin\Desktop\insider threat\cert4.2'
sample_path= r'C:\Users\Ahin\Desktop\insider threat\sample _data'
...
for i in trange(df_head.shape[0]):
    df_user = pd.read_csv(os.path.join('C:\\Users\\Ahin\\Desktop\\insider threat\\cert4.2\\user_file\\day_seq_dir', df_head.iloc[i]['user_index'] + '.csv'))
    print(len(df_user))
